...
export default function ComparisonSection() {
  const features = [
    { label: "Compatibility Matching", daft: false, fb: false, RoomFind: true, sub: "(6 factors)" },
    { label: "Profile Verification", daft: false, fb: false, RoomFind: true, sub: "(Email, phone, opt. ID)" },
    { label: "Privacy Control", daft: false, fb: false, RoomFind: true, sub: "(Public or private)" },
    { label: "Message Quality", daft: false, fb: false, RoomFind: true, sub: "(High-match only)" },
    { label: "Built-in Messaging", daft: false, fb: false, RoomFind: true, sub: "(Secure)" },
    { label: "Mobile Experience", daft: "warn", fb: "warn", RoomFind: true, sub: "(Mobile-first)" },
    { label: "Price", daft: "€50-100 to list", fb: "Free", RoomFind: "100% Free", isText: true },
  ];
      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-navy-950 mb-4">
                Why RoomFind Beats Traditional Platforms
            </h2>
                        ...
                        {features.map((row, i) => (
                            <tr key={i} className="hover:bg-slate-50 transition-colors">
                                ...
                                <td className="p-6 text-center bg-terracotta-50/30">
                                    {renderIcon(row.RoomFind)}
                                    {row.RoomFind === true && row.sub && !features.find(f => f.label === row.label).isText && (
